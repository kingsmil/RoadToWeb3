...
contract SoulRune is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
    ...
    //mappings method was too gas intensive, using balanceof instead, commented out mapping method
    //SET "GLOBAL" VARS TO HELP LATER
    uint256 public MAX_SUPPLY = 10000;
    uint256 public MAX_MINT_AMT = 5;
//"Hash" mapped each addres into a 256uint which stores total minted amount;
